...
export { default as AppointmentStep } from './AppointmentStep';
...
export { default as ABTestingVariant } from './ABTestingVariant';
export { default as ConnectionStatus } from './ConnectionStatus';
// export { default as AppointmentStep } from './AppointmentStep'; // Uncomment when AppointmentStep is properly implemented 